    ...
    <div className="flex items-center justify-center min-h-[50vh]">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <div className="space-y-4">
          <div className="relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full px-4 py-2 pl-10 pr-24 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400"
              />
          ...
          <div className="relative">
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-2 pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 appearance-none"
              >
          ...
          <button
            onClick={handleLogin}
            className="w-full px-4 py-2 font-bold text-white bg-red-500 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
          >
            Login
          </button>
        </div>
